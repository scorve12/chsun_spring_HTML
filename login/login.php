...
<body>
    ...
    <div class="login-container">
        ...
        <form method='post' action='login_action.php'>
            <p><b>ID &nbsp;</b><input name="id" type="text" id="id"></p>
            <p><b>PW &nbsp;</b><input name="pw" type="password" id="pw"></p>
            <input type="submit" class="g-recaptcha" data-sitekey="6LfRnskpAAAAAKRUJA7W8CPmtS_FdTrH71BHTsPA"
                data-callback='onSubmit' value="로그인">&nbsp;&nbsp;
        </form>
