...
<body>    
    <div class="container">
        <!-- 사용자 입력 폼 -->
        <form id="postForm" style="margin-top: 20px;" method="post" action="board_write_action.php" enctype="multipart/form-data" autocomplete="off">
            ...
            <input type="checkbox" id="updateCheckbox" onchange="updatePostCheckbox()"><br>
